...
answer-packed receipts while the case runs. The observer wrappers do not change
model requests, return values or call order. This local diagnostic adds no core,
