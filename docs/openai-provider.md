# Optional OpenAI adapter — offline-verified preview

This source adapter connects the same core's extract/classify/select/rank ports
to pinned `gpt-4.1-mini-2025-04-14`. It is **not live-validated**. Transport
fixtures do not establish semantic quality, client support or launch readiness.
...
Roadmap 2a still needs a real synthetic lifecycle and count/usage agreement under
authorized test credentials and a paid-run ceiling. No automatic live-test
command is included. Frozen semantic/resource evaluation remains separate 2b.
