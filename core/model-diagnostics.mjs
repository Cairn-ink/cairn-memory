const stages = new Set(['extract', 'classify', 'select', 'rank', 'reconcile', 'qualify', 'qualifyCandidates', 'relate']);
const reasons = {
  ...
  core_validation: new Set(['invalid_extraction', 'invalid_qualification', 'invalid_classification', 'invalid_reconciliation', 'invalid_rationale', 'malformed_refs',
