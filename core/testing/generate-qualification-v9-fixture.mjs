...
// Usage: node core/testing/generate-qualification-v9-fixture.mjs /absolute/unmodified/base/checkout
...
const base = '3512719a3c43c14354f76c31064d8d62666e97bf';
...
const path = join(mkdtempSync(join(tmpdir(), 'cairn-v9-fixture-recipe-')), 'synthetic.sqlite');
...
const namespace = { ownerId: 'qualification-v9-synthetic', scope: 'personal', projectId: null };
...
console.log(JSON.stringify({ provenance: { base, node: process.version, recipe: 'core/testing/generate-qualification-v9-fixture.mjs', synthetic: true },
  namespace, key, captureInput, captureResult, rebuild, cursor, next, history, schema, tables }, null, 2));
db.close(); core.close();
